      ...
      <div class="container mx-auto px-6 py-2">
          <div class="text-right">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Post create')): ?>
              <a href="<?php echo e(route('admin.posts.create')); ?>" class="bg-blue-500 text-white font-bold px-5 py-1 rounded focus:outline-none shadow hover:bg-blue-500 transition-colors ">New post</a>
            <?php endif; ?>
          </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ngen_task\resources\views/post/index.blade.php ENDPATH**/ ?>