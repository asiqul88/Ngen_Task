            ...
            <div class="container mx-auto px-6 py-1 pb-16">
              <div class="bg-white shadow-md rounded my-6 p-5">
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <textarea name="description" id="description" placeholder="Enter description" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200" rows="5"><?php echo e(old('description')); ?></textarea>
                </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ngen_task\resources\views/post/new.blade.php ENDPATH**/ ?>